...
public class JobSeeker {
	...
	public String toString() {
		return "JobSeeker [id=" + id + ", name=" + name + ", email=" + email + ", mobile=" + mobile + ", password="
				+ password + ", confirmPassword=" + confirmPassword + ", completed=" + completed + ", verified="
				+ verified + ", otp=" + otp + ", jobApplications=" + jobApplications + ", education=" + education
				+ ", experience=" + experience + ", resumeUrl=" + resumeUrl + ", profilePicUrl=" + profilePicUrl + "]";
	}
